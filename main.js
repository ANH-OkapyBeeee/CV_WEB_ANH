...
const PROF_DATA = {
    ia: {
        ...
        color: "#38bdf8",
        image: "assets/images/perfil-2.png",
    ...
    software: {
        ...
        color: "#818cf8",
        image: "assets/images/perfil-1.png",
...
function switchProfile(profileKey) {
    ...
    // 1.1 Actualizar Enlaces de Descarga (PDF/Word ATS)
    const cvPath = `assets/cvs/${profileKey}`;
    document.querySelector('#pdf1p').href = `${cvPath}_1page.pdf`;
    document.querySelector('#pdf2p').href = `${cvPath}_2pages.pdf`;
    document.querySelector('#doc1p').href = `${cvPath}_1page.docx`;
    document.querySelector('#doc2p').href = `${cvPath}_2pages.docx`;
